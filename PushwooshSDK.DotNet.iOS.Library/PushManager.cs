...
{
    public class PushManager : PushwooshSDK.DotNet.Core.PushManager
    {
        public static new PushManager Instance => global::PushwooshSDK.DotNet.Core.PushManager.Instance as PushManager;
            ...
            nativeManager.LoadTags((NSDictionary tagsDict) =>
            {
                ...
                foreach (var kv in tagsDict)
                {
                    if (kv.Key is NSString)
                    {
                        ...
                        else if (kv.Value is NSArray && kv.Value != null)
                        {
                            tags.PutList(((NSString)kv.Key).ToString(), kv.Value as IList<string>);
                        }
                    }
                }
        ...
        protected override global::PushwooshSDK.DotNet.Core.PushNotificationSettings GetNotificationSettings()
        {
            return NotificationSettings;
        }
